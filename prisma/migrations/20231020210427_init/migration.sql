...
CREATE TABLE "Grupo" (
    ...
    "matricula_lider" INTEGER NOT NULL,
...
CREATE TABLE "AvaliacaoAluno" (
    "numero_avaliacao" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "matricula_avaliador_aluno" INTEGER NOT NULL,
...
CREATE TABLE "AvaliacaoProfessor" (
    "numero_avaliacao" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "matricula_avaliador_professor" INTEGER NOT NULL,
    "numero_grupo_avaliado" INTEGER NOT NULL,
    "nota" INTEGER NOT NULL,
...
CREATE TABLE "Avaliacao" (
    "numero_avaliacao" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "numero_avaliacao_aluno" INTEGER NOT NULL,
    "numero_avaliacao_professor" INTEGER NOT NULL,
    "numero_grupo_avaliado" INTEGER NOT NULL,
